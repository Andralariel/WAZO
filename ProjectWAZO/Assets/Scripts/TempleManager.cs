...
public class TempleManager : Activator
{
    ...
    IEnumerator ActivateEscalier1()
    {
        ...
        Escalier1.transform.DOMove(
            new Vector3(Escalier1.transform.position.x, Escalier1.transform.position.y + 7,
    ...
    IEnumerator ActivateEscalier2()
    {
        ...
        Escalier2.transform.DOMove(
            new Vector3(Escalier2.transform.position.x, Escalier2.transform.position.y + 10,
